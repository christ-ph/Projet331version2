...
const mainMenuItems = computed(() => {
  ...
  if (role.value === "FREELANCE") {
    return [
      ...
      { label: "Propositions", icon: "fas fa-paper-plane", path: "/propositions", badge: null },
      { label: "Discussions", icon: "fas fa-comments", path: "/messages", badge: unreadMessages.value },
